...
#define CONFIG_BOOTARGS    	"noinitrd root=/dev/mtdblock2 console=ttySAC2 init=/init skipCalibrate radio=none my_version=${latestVer}" 
...
#define CONFIG_BOOTCOMMAND	"movi read kernel C0008000; movi read rootfs 40800000 180000; bootm C0008000 40800000"
#endif
